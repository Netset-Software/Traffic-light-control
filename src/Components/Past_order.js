        ...
        <>
            ...
            <section className="product-detials-page pb-3">
                <div className="details_popup text-center mb-4">
                    <marquee><p>Your order has been delivered to you on "May 20,2021 & 10:30 AM".</p></marquee>
                </div>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-12">
                            ...
                            <div className="review_btn text-center">
                                <button class="btn" onClick={() => setLgShow(true)}>Give Rating & Reviews</button>        
                            </div>
                            <div className="review_head mt-2">
                                <h5 className="my-2"><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><span></span></h5>  
                                <h6><i className="fa fa-clock-o"></i> 30min</h6>
                            </div>
                            <p>Enjoy best practices to reshape your health to maintain a healthy lifestyle. Lifestyle modification can be painful or uncomfortable, the BIG4 Health app presents a seamless way to adapt to a healthier lifestyle. </p>
                        </div>
                    </div>
                </div>
            </section>
