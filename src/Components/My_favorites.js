                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-4">
                            <p className="like-favorite-box"onClick={() => openModalremove()}><img src={require("../images/like.png").default} alt="img" /></p>
                            ...
                            <div className="product-list-box">
                                ...
                                <div className="product-list-details">
                                    ...
                                    <h6><i className="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i> <span className="total-review ml-1">(1.2k reviews)</span></h6>
